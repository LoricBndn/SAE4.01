...
function register() {
  ...
  let testConfirm =
    confirmPasswordField === document.getElementById("mdp").value;
  ...
  console.log(user);
  fetch(
    "https://devweb.iutmetz.univ-lorraine.fr/~bondon3u/2A/SAE4.01/Application/V1/serveur/api/newUser.php",
    {
      method: "POST",
